  ...
  useEffect(()=>{
    (async()=>{
      try {
        ...
        // MUHIM: mahalliy (localStorage) ma'lumot ESKIRGAN yoki
        // to'liq bo'lmasligi mumkin (masalan boshqa qurilmada
        // qo'shilgan karta) — shuning uchun BACKEND'dan HAQIQIY
        // ro'yxatni olib, ustidan yozamiz. Backend — "haqiqat manbai".
        try {
